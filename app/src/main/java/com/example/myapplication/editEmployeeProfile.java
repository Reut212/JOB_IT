...
public class editEmployeeProfile extends AppCompatActivity {
    ...
    private EditText fNameEditText, lastNameEditText, EmailEditText;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        updateBtn = findViewById(R.id.updateEmployeeProfileBTN);
        profileImage = findViewById(R.id.employee_profile_image_update);
        fNameEditText = findViewById(R.id.editProfEmployeeFNText);
        lastNameEditText = findViewById(R.id.editProfEmployeeLNText);
        EmailEditText = findViewById(R.id.editProfEmployeeEmailText);
        changeImage = findViewById(R.id.changeEmployeeProfileImage);
        ...
        ref = fStore.collection("Employees").document(Uid);

        changeImage.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ImagePicker.Companion.with(editEmployeeProfile.this)
                        ...
                        if (task.getResult().exists()) {
                            ...
                            ref.update(userHashMap).addOnSuccessListener(new OnSuccessListener<Void>() {
                                ...
                                public void onSuccess(@NonNull Void unused) {
                                    ...
                                    Toast.makeText(editEmployeeProfile.this, "Profile Updated!", Toast.LENGTH_SHORT).show();
                                }
                            });
                        }
                    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        storageReference.putFile(uri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                ...
                ref.update(userUrl).addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void unused) {
                        Toast.makeText(editEmployeeProfile.this, "successfully uploaded", Toast.LENGTH_SHORT).show();
            ...
            @Override
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(editEmployeeProfile.this, "failed to upload", Toast.LENGTH_SHORT).show();
                if (progressDialog.isShowing()) progressDialog.dismiss();
            }
        });
    }
