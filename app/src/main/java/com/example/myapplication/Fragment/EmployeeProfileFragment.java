...
import com.example.myapplication.editEmployeeProfile;
...
public class EmployeeProfileFragment extends Fragment{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        logOutBtn = rootView.findViewById(R.id.logOutEmployeeBtn);
        editProfile = rootView.findViewById(R.id.editEmployeeProfile);
        fNameEditText = rootView.findViewById(R.id.firstNameEmployeeTextView);
        lastNameEditText = rootView.findViewById(R.id.lastNameEmployeeTextView);
        EmailEditText = rootView.findViewById(R.id.emailEmployeeTextView);
        profileImage = rootView.findViewById(R.id.employee_profile_image);
    ...
    public void onStart() {
        ...
        editProfile.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(requireActivity() , editEmployeeProfile.class));
            }
        });
