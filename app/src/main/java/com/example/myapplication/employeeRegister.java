...
public class employeeRegister extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rButton = (Button) findViewById(R.id.employeeRegisterButton);
        ...
        rButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                registerEmployee(fNameText, lNameText, emailText, passwordText);
            }
        });
    }

    public void registerEmployee(String fNameText, String lNameText, String emailText, String passwordText) {
            ...
            if (task.isSuccessful()) {
                databaseReference.child("users").child(fAuth.getCurrentUser().getUid()).child("email").setValue(eMail.getText().toString()).addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        if(task.isSuccessful()) {
                            Toast.makeText(employeeRegister.this, "SignUp Success", Toast.LENGTH_SHORT).show();
                        }
                    }
                }).addOnFailureListener(new OnFailureListener() {
                    @Override
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(employeeRegister.this , "Failure in saving data " + e.getMessage() , Toast.LENGTH_SHORT).show();
                    }
                });
                ...
                fuser.sendEmailVerification().addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void unused) {
                        Toast.makeText(employeeRegister.this, "Verification Email Has been Sent"
                ...
                Toast.makeText(employeeRegister.this, "User Created", Toast.LENGTH_SHORT).show();
                ...
                Toast.makeText(employeeRegister.this, "Error !" + task.getException().getMessage(),
                        Toast.LENGTH_SHORT).show();
            }
        });
    }
